...
urlpatterns = [
    # AI Recommendations
    path('recommendations/', views.StationRecommenderView.as_view(), name='ai-recommendations'),
    
    # User Preferences
    path('preferences/', views.UserSearchPreferencesView.as_view(), name='user-preferences'),
    
    # Vehicle Management - MOVED TO AUTHENTICATION APP
    ...
    # Sentiment Analysis
    path('stations/<uuid:station_id>/sentiment/', views.StationSentimentAnalysisView.as_view(), name='station-sentiment'),
